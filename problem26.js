...
function publicBusFare(peopleQuantity){
    ...
    const remeningPeople1 = peopleQuantity % busCapacity;
    const remeningPeople2 = remeningPeople1 % microbusCapacity;
    const publicBusTaka = remeningPeople2 * publicBusTicketPrice;
